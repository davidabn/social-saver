...
async function getTranscriptionStatus(transcriptId: string): Promise<TranscriptResponse> {
...
// Poll for completion
async function waitForTranscription(transcriptId: string, maxWaitMs = 300000): Promise<string> {
...
export async function transcribeVideo(contentId: string, videoUrl: string): Promise<void> {
  if (!ASSEMBLYAI_API_KEY) {
...
export function queueTranscription(contentId: string, videoUrl: string): void {
