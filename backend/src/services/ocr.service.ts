...
export function queueImageTranscription(contentId: string, imageUrls: string[]): void {
...
export async function transcribeImages(contentId: string, imageUrls: string[]): Promise<void> {
